...
class SmoothAnimation extends Anim{
    private path:Vector[] = []
    ...
    static easeInEaseOut = [...SmoothAnimation.in,...SmoothAnimation.out]
    static easeOut = [botleft,center,...SmoothAnimation.out]
    static easeIn = [...SmoothAnimation.in,center,topright]
}
